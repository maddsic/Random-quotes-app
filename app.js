...
let Authors_quote = quotes[quoteIndex].quote;
let authors_name = quotes[quoteIndex].author;

quote_content.textContent = Authors_quote;
author_name.textContent = authors_name;

document.querySelector(".js-btn").addEventListener('click', function(event){
event.preventDefault()

quoteIndex = Math.floor(Math.random() * 43 + 1);
Authors_quote = quotes[quoteIndex].quote;
authors_name = quotes[quoteIndex].author;
